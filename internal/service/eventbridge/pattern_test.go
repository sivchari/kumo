...
func TestMatchEventPattern(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			pattern: "",
			event:   PutEventsRequestEntry{Source: testEventSourceMyApp, DetailType: testDetailTypeOrder},
			want:    true,
		},
		{
			name:    "source match",
		...
		},
		{
			...
			event:   PutEventsRequestEntry{Source: testEventSourceMyApp},
			want:    true,
		},
		{
		...
		},
		{
			...
			event:   PutEventsRequestEntry{Source: testEventSourceMyApp, Detail: `{"status": "completed", "amount": 100}`},
			want:    true,
		},
		{
			name:    "detail field mismatch",
			pattern: `{"detail": {"status": ["pending"]}}`,
			event:   PutEventsRequestEntry{Source: testEventSourceMyApp, Detail: `{"status": "completed"}`},
			want:    false,
		},
		{
